...
public class BackgroundTask extends AsyncTask<Void,Void,Void> {
    ...
    public BackgroundTask(Context context, String email, String phone_no, String Uname) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            //Adding receiver
            mm.addRecipient(Message.RecipientType.TO, new InternetAddress("anandha1734@gmail.com"));
            //Adding subject
